export class Fight {
    ...
    private readonly _typesForChart = ["normal", "fire", "water", "electric", "grass", "ice", "fighting", "poison", "ground", "flying", "psychic", "bug", "rck", "ghost", "dragon", "dark", "steel", "fairy"]
    ...
    calculateAttackEffectiveness(attackType: string, pokemonDefenceTypes: number[]): number {
